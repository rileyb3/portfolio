  ...
  return (
    ...
    >
      ...
      <aside
        ...
        // w-[86%] rather than w-full: on a phone a full-width panel wipes
        // the scene out entirely, and the point of the layout is seeing the
        // water light up next to what you picked. The strip left over also
        // gives back the tap-outside-to-close that a full-bleed panel takes
        // away.
        className={`fixed right-0 top-0 z-[60] flex h-[100svh] w-[86%] max-w-md flex-col overflow-y-auto border-l border-white/10 bg-surface/95 px-6 pb-16 pt-8 backdrop-blur-xl transition-transform duration-500 ease-out sm:px-8 ${
